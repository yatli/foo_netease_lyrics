...
//If you want to create custom requirements, you must derive from here. See netease_lyrics_source.cpp for an example of it's usage.
...
//! See netease_lyrics_source.cpp for more explanantion.
...
public:
	...
	//! @param p_results - The client where you can add your lyric results. see above and in netease_lyrics_source.cpp for more info.
	//! @param pRequirements - You don't have to use this. It's purpose is to allow to you to save some data (or whatever) so you can then use it in the Search() function. To use it you need to create your own search_requirements class, see netease_lyrics_source.h and netease_lyrics_source.cpp for an example.
