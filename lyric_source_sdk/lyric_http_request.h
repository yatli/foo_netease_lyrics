...
public:
	...
	virtual bool do_post_request( pfc::string_base& output, const char* userAgent, const char* host, WORD port, const char* request, const char* header, LPCWSTR post_data, unsigned int post_size ) = 0;
