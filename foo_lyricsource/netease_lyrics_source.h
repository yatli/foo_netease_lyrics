...
class netease_lyrics_source : public lyric_source_base
{
...
public:
	...
	netease_lyrics_source() : lyric_source_base() { };
	~netease_lyrics_source() {
	};

	void GetName( pfc::string_base& out ) { out = "NetEase Music"; }
